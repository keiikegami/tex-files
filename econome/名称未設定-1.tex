...
\subsection{(b)}
\begin{align*}
	M &= I_{NT} - \left( \iota_T \otimes I_N \right) \left( \left( \iota_T \otimes I_N \right)^{'} \left( \iota_T \otimes I_N \right) \right)^{-1} \left( \iota_T \otimes I_N \right)^{'}\\[8pt]
	&= I_{NT} - \left( \iota_T \otimes I_N \right)(T\cdot I_N)^{-1} \left( \iota_T \otimes I_N \right)^{'}\\[8pt]
	&= I_{NY} - \frac{1}{T}\left( \iota_T\iota_T^{'} \otimes I_N\right)
\end{align*}
Then,
\begin{align*}
	My &= y - \frac{1}{T}\left( \iota_T\iota_T^{'} \otimes I_N\right)y\\[8pt]
	&= y - \frac{1}{T}\left( \iota_T\iota_T^{'} \otimes I_N\right) 
\end{align*}

...
The main reason why there exists super crowded trains in rush hour is that such trains arrive at the time when both groups of players are in the station. I model this situation by overlapping the two groups of trains. That is the last train in the former half train group is the first train in the later half train group.

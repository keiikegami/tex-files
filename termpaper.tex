...
\par
And denote the case 1 as "no quality gap setting", the case 2 as "one side quality gap setting" and case 6 as "two side gap setting". I analyze these three cases in the below section. 

...
\begin{align*}
	A \cap \left( \mathbb{R}\setminus \bigcup_i A_i \right) = \left( \mathbb{R} \cap A \right)  \setminus \bigcup_i A_i = \mathbb{R} \setminus \left( \mathbb{R}\setminus \left( \left( \mathbb{R} \cap A \right)  \setminus \bigcup_i A_i \right)\right) = \mathbb{R} \setminus \bigcup_i \left( \mathbb{R}\setminus \left( (\mathbb{R} \setminus A_i) \cap A \right) \right)
\end{align*}

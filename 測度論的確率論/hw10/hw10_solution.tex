...
\end{align*}
を得る。ただし、不等号はFatouの補題より得られ、4番目の等号は仮定より得られる。従って、Theorem 3.2.11(2)より確かに$X_n \xrightarrow{w} X_{\infty}$である。
...
\end{align*}
である。$X, X_n$の分布関数をそれぞれ$F. F_n$で書くとすると、これより$F(x-\epsilon) - P\left(  |X- X_n| > \epsilon \right) \leq F_n(x)$であり、$X_n \xrightarrow{p}X$であることより左辺第二項は$0$に収束することから、両辺$\liminf$をとると、$F(x-\epsilon) \leq \liminf_{n} F_n(x)$である。同じように以下が成立することを使う。
\begin{align*}
...
\end{align*}
仮定より右辺第2項は$0$に収束するので、両辺$\limsup$をとると、$\limsup_n F_n(x) \leq F(x+\epsilon)$を得る。以上を合わせると、任意の$\epsilon > 0$に対して、
\begin{align*}

...
\section{Models}
	...
	\subsection{Nonequilibrium Level-k Models}
		...
		\begin{frame}\frametitle{Random L2 , Truthful L1 and Truthful L2}
			...
			\item For L2 in this case, the high bid among the other players conveys the information about the value of the object, then L2 adjust its own estimated value according to the information.
		...
		\begin{frame}\frametitle{General Bidding for the three Cases in First Price Auction}
			\begin{itemize}
			\item 
			\end{itemize}
		\end{frame}
		
		\begin{frame}\frametitle{General Bidding for the three Cases in Second Price Auction}
			\begin{itemize}
			\item 
			\end{itemize}
		\end{frame}
